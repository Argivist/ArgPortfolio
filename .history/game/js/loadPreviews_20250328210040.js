...
function createPreview(row) {
  ...
  if (row.mediaType && row.mediaType.toLowerCase() === 'youtube') {
    ...
    mediaElement.src = `https://www.youtube.com/embed/${row.youtubeId}/hqdefault.jpg?controls=0&modestbranding=1`;
...
function openModal(row) {
  ...
  if (row.mediaType && row.mediaType.toLowerCase() === 'youtube') {
    ...
    iframe.width = "100%";
    iframe.height = "100%";
    iframe.src = `https://www.youtube.com/embed/${row.youtubeId}?controls=0&modestbranding=1`;
